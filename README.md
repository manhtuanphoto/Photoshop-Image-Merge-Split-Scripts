# Photoshop Image Split & Merge Scripts
...
<div align="center">
  <img src="https://private-user-images.githubusercontent.com/146505436/519235827-7319ecc6-2d96-4d6b-87e1-60b89fb33be7.JPG?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbSIsImtleSI6ImtleTUiLCJleHAiOjE3NjQxNjg5NjcsIm5iZiI6MTc2NDE2ODY2NywicGF0aCI6Ii8xNDY1MDU0MzYvNTE5MjM1ODI3LTczMTllY2M2LTJkOTYtNGQ2Yi04N2UxLTYwYjg5ZmIzM2JlNy5KUEc_.8zMg3lQskBC4cyf-A9m_kL8TTY43WG2fyd7jPFvHYe8" alt="Donate QR Code" width="300"/>
  <br>
  <em>Scan to donate via MoMo, VietQR, or Napas247</em>
</div>
...
Nếu bạn thấy các scripts này hữu ích, hãy mời tôi một ly cà phê nhé! ☕

<div align="center">
  <img src="# Photoshop Image Split & Merge Scripts
...
<div align="center">
  <img src="https://i.imgur.com/your-qr-code.png" alt="QR Code Donate" width="300"/>
  <br>
  <em>Quét mã để donate qua MoMo, VietQR, hoặc Napas247</em>
</div>
...
- [Các Scripts](#các-scripts)
  - [Script Ghép Ảnh](#1-script-ghép-ảnh)
  - [Script Chia Ảnh](#2-script-chia-ảnh)
...
**Chúc bạn sử dụng hiệu quả! / Happy editing!** 🎨" alt="QR Code Donate" width="300"/>
  <br>
  <em>Quét mã để donate qua MoMo, VietQR, hoặc Napas247</em>
</div>
